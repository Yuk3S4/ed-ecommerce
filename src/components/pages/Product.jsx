...
import ProductRating from "../atoms/ProductRaiting"
...
import ShareProduct from "../molecules/SharedProduct"

const Product = () => {
    const params = useParams()
    const { state, dispatch } = useContext(CartContext)
    const { data, error, loading } = useFetch(`public/products/${ params.id }`)
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            { sold > 300 && <Badge text="Lo más vendido" /> }
                            { isNew && <Badge text="Nuevo" /> }
                        </div>

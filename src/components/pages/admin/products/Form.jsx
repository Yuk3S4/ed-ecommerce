...
const Form = () => {
  ...
  // Obtener parametros del URL en este caso obtener el ID - /admin/productos/editar/:id <- parámetro
  ...
  const handleSubmit = (e) => {
    ...
    if (!params.id) { // Creando un producto
      axios
  ...
  return (
    <div className="max-w-256 m-auto">
      <section className="pt-10">
        {
          error && (
            <p className="mb-8 text-center p-2 bg-red-100 font-bold text-red-500">{ error?.response?.data?.errors[0].message }</p>  
          )
        }
